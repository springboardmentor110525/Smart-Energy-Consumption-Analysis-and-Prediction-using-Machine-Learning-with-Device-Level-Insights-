...
The original dataset contains smart home energy consumption data

Due to size and privacy reasons, datasets are ignored in this repository

Sample or placeholder files may be used for testing
...
Integration with Flask prediction API

🔐 Security & Best Practices

Sensitive files and large datasets excluded using .gitignore
...
Shaik Sameera – Developer & ML Engineer
...
Smart energy research datasets
